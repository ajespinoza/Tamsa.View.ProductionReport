// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EventHandlerGenerator.cs" company="Tenaris">
//   Tenaris.
// </copyright>
// <summary>
//   Defines the EventHandlerGenerator.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Tamsa.View.ProductionReport.ViewModel
{
    ...
    public static class EventHandlerGenerator
    {
        ...
        public static Delegate CreateDelegate(Type eventHandlerType, MethodInfo methodToInvoke, object methodInvoker)
        {
            ...
            DynamicMethod handler = new DynamicMethod(string.Empty, null, hookupParameters, typeof(EventHandlerGenerator));
